...
<div class="main-content p-4">
    <div class="content-card" style="border-radius: 15px; overflow: hidden; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);">
        <div class="card-header-custom" style="border-bottom: 2px solid rgba(0, 0, 0, 0.05); padding: 15px;">
            <h4 style="font-weight: 700; color: var(--text-dark); margin: 0;">Edit Data Warga</h4>
        ...
        <form action="{{ route('data_warga.update', $warga->id) }}" method="POST" style="padding: 15px;">
            @csrf
            @method('PATCH')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="no_registrasi" value="{{ old('no_registrasi', $warga->no_registrasi) }}" class="form-control" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="no_ktp" value="{{ old('no_ktp', $warga->no_ktp) }}" class="form-control" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $warga->nama) }}" class="form-control" required style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                ...
                <div class="col-md-4">
                    ...
                    <select name="jabatan_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($jabatan as $j)
                            <option value="{{ $j->id }}" {{ old('jabatan_id', $warga->jabatan_id) == $j->id ? 'selected' : '' }}>{{ $j->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $warga->tempat_lahir) }}" class="form-control" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $warga->tanggal_lahir) }}" class="form-control" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status_perkawinan_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($statusPerkawinan as $s)
                            <option value="{{ $s->id }}" {{ old('status_perkawinan_id', $warga->status_perkawinan_id) == $s->id ? 'selected' : '' }}>{{ $s->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="agama_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="">-- Pilih --</option>
                        @foreach($agama as $a)
                            <option value="{{ $a->id }}" {{ old('agama_id', $warga->agama_id) == $a->id ? 'selected' : '' }}>{{ $a->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="pendidikan_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($pendidikan as $p)
                            <option value="{{ $p->id }}" {{ old('pendidikan_id', $warga->pendidikan_id) == $p->id ? 'selected' : '' }}>{{ $p->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="pekerjaan_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($pekerjaan as $pk)
                            <option value="{{ $pk->id }}" {{ old('pekerjaan_id', $warga->pekerjaan_id) == $pk->id ? 'selected' : '' }}>{{ $pk->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="ikut_paud" id="ikut_paud" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="">-- Pilih --</option>
                        <option value="ya" {{ old('ikut_paud', $warga->ikut_paud) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('ikut_paud', $warga->ikut_paud) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="ikut_kelompok_belajar" id="ikut_kelompok_belajar" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="">-- Pilih --</option>
                        <option value="ya" {{ old('ikut_kelompok_belajar', $warga->ikut_kelompok_belajar) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('ikut_kelompok_belajar', $warga->ikut_kelompok_belajar) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    @error('ikut_kelompok_belajar') <small class="text-danger" style="font-size: 12px;">{{ $message }}</small> @enderror
                </div>

                <!-- Jenis Kelompok Belajar (SELALU ADA, DIKENDALIKAN JS) -->
                <div class="col-md-4">
                    ...
                    <select name="jenis_kelompok_belajar_id" id="jenis_kelompok_belajar_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($jenisKelompokBelajar as $item)
                            <option value="{{ $item->id }}" {{ old('jenis_kelompok_belajar_id', $warga->jenis_kelompok_belajar_id) == $item->id ? 'selected' : '' }}>
                                {{ $item->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="ikut_akseptor_kb" id="ikut_akseptor_kb" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="">-- Pilih --</option>
                        <option value="ya" {{ old('ikut_akseptor_kb', $warga->ikut_akseptor_kb) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('ikut_akseptor_kb', $warga->ikut_akseptor_kb) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="jenis_akseptor_kb_id" id="jenis_akseptor_kb_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($jenisAkseptorKb as $ja)
                            <option value="{{ $ja->id }}" {{ old('jenis_akseptor_kb_id', $warga->jenis_akseptor_kb_id) == $ja->id ? 'selected' : '' }}>
                                {{ $ja->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="ikut_koperasi" id="ikut_koperasi" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="">-- Pilih --</option>
                        <option value="ya" {{ old('ikut_koperasi', $warga->ikut_koperasi) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('ikut_koperasi', $warga->ikut_koperasi) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="jenis_koperasi_id" id="jenis_koperasi_id" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        ...
                        @foreach($jenisKoperasi as $jk)
                            <option value="{{ $jk->id }}" {{ old('jenis_koperasi_id', $warga->jenis_koperasi_id) == $jk->id ? 'selected' : '' }}>
                                {{ $jk->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="memiliki_tabungan" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="ya" {{ old('memiliki_tabungan', $warga->memiliki_tabungan) == 'ya' ? 'selected' : '' }}>Ya</option>
                        <option value="tidak" {{ old('memiliki_tabungan', $warga->memiliki_tabungan) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select name="active" class="form-select" style="border-radius: 10px; border: 2px solid rgba(0, 0, 0, 0.05);">
                        <option value="1" {{ old('active', $warga->active) == 1 ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ old('active', $warga->active) == 0 ? 'selected' : '' }}>Nonaktif</option>
                    </select>
...
$(document).ready(function () {
    const toggleJenis = (triggerId, targetId) => {
        ...
        update(); // Jalankan saat load (termasuk old() & data edit)
    };
