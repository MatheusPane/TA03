...
<div class="main-content p-4">
    <div class="content-card" style="border-radius: 15px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
        <div class="card-header-custom" style="background: linear-gradient(135deg, var(--primary), var(--primary-light)); color: white; padding: 15px;">
            ...
            <a href="{{ route('ref_jenis_usaha.index') }}" class="btn btn-light" style="border-radius: 10px;">
                Kembali
            </a>
        </div>
        ...
        <div class="p-4">
            ...
            <form action="{{ route('ref_jenis_usaha.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="form-label">Nama Jenis Usaha <span class="text-danger">*</span></label>
                    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" 
                           value="{{ old('nama') }}" placeholder="Contoh: Pertanian, Perdagangan" required>
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('ref_jenis_usaha.index') }}" class="btn btn-secondary" style="border-radius: 10px;">
                        Batal
                    </a>
                </div>
            </form>
