...
<div class="container mt-4">
    <h1 class="mb-4">Edit Status Dalam Keluarga</h1>
    ...
    {{-- Form Edit --}}
    <form action="{{ route('ref_status_dalam_keluarga.update', $refStatusDalamKeluarga->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control"
                   value="{{ old('nama', $refStatusDalamKeluarga->nama) }}" required>
        </div>
