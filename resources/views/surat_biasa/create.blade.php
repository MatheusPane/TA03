{{-- resources/views/surat_biasa/create.blade.php --}}
@extends('layouts.layout')

@section('title', 'Buat Surat Biasa')

@section('content')
<div class="main-content p-4">
    <div class="content-card p-4 rounded-3 shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold text-primary">Buat Surat Biasa</h4>
            <a href="{{ route('surat-biasa.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
        </div>

        <form action="{{ route('surat-biasa.store') }}" method="POST">
            @csrf
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="kata_pembuka" rows="3" class="form-control @error('kata_pembuka') is-invalid @enderror" required>{{ old('kata_pembuka') }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea name="isi_surat" rows="6" class="form-control @error('isi_surat') is-invalid @enderror" required>{{ old('isi_surat') }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea name="penutup" rows="3" class="form-control @error('penutup') is-invalid @enderror" required>{{ old('penutup') }}</textarea>
